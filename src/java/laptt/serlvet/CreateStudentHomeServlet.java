...
@WebServlet(name = "CreateStudentHomeServlet", urlPatterns = {"/CreateStudentHomeServlet"})
public class CreateStudentHomeServlet extends HttpServlet {

    private static final Logger logger = Logger.getLogger(CreateStudentHomeServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String url = servletContext.getInitParameter("student-home-jsp");
