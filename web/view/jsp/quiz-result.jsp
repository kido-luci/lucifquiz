...
<head>
    ...
    <!-- title -->
    <title>Lucif Quiz - Student Home - Quiz Result</title>
...
<div class="login-bg" style="width: 760px!important;border-radius: 18px!important;margin: auto!important;">
    <div class="login-content" style="border-radius: 18px!important;border: 2px solid #F28123!important;padding-bottom: 30px!important;background-color: #1f1e1dbf!important;">
        <h2 class="title login">Quiz Result</h2>
        <h2>Correct Answer : ${requestScope.NUMBER_ANSWER_CORRECT}/${requestScope.NUMBER_OF_QUESTION}</h2>
        <h2>Point : ${requestScope.NUMBER_ANSWER_CORRECT * 5}/${requestScope.NUMBER_OF_QUESTION * 5}</h2>
        <h2>Submit time : ${requestScope.SUBMIT_TIME}</h2>
